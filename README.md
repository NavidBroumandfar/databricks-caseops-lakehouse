...
[![Tests](https://img.shields.io/badge/Tests-1%2C500%20passing-2EA043?style=flat-square)](./tests/)
...
├── tests/                   # 1,500 tests across all pipeline stages and contract layers
└── examples/
