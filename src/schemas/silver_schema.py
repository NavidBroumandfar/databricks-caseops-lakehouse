...
V1 implements the FDA warning letter field set only. Additional domain field
sets are planned for V2+ and should be added as separate Pydantic models.
...
class SilverRecord(BaseModel):
    ...
    # --- Extracted content ---
    extracted_fields: Optional[FDAWarningLetterFields] = Field(
        default=None,
